class Package(j.baseclasses.threebot_package):
    ...
    j.threebot.packages.zerobot.packagemanager.actors.package_manager.package_add(git_url="https://github.com/freeflowtoken/www_freeflowtoken_com")
    """

    def _init(self, **kwargs):
        self.branch = kwargs["package"].branch or "master"
        self.enertia_io = "https://github.com/freeflowtoken/www_freeflowtoken_com"
